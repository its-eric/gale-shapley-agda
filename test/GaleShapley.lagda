...
--shouldn't happen in an ideal world : woman received a proposal from an unknown man??
... | just p  | nothing = false
--shouldn't happen in an ideal world : woman married an unknown man previously??
...
...               | true  = mkState men freeMenUpdated engagedMenUpdated women (safeAddNewCouple (n , w) couples) (compSumPrefLists freeMenUpdated engagedMenUpdated) refl
                           where
                               freeMenUpdated    = proj₂ (safeAddNewEngagedMan′ (n , prefs) h engagedMen) ∷ freeMen
...
stepDec : (m : MatchingState) → MatchingState.sumPrefLists m ≥′ MatchingState.sumPrefLists (step m)
...
anyMatchIsBetter m (mkState men freeMen [] women couples sumPrefLists sumEq) (mkState men₁ freeMen₁ [] women₁ couples₁ sumPrefLists₁ sumEq₁) p₁ (fst , snd) (fst₁ , snd₁) = (fst , snd) , (fst₁ , snd₁) , {!!}
anyMatchIsBetter m (mkState men freeMen [] women couples sumPrefLists sumEq) (mkState men₁ freeMen₁ (x ∷ engagedMen₁) women₁ couples₁ sumPrefLists₁ sumEq₁) p₁ (fst , snd) (fst₁ , snd₁) = {!!}
anyMatchIsBetter m (mkState men freeMen (x ∷ engagedMen) women couples sumPrefLists sumEq) (mkState men₁ freeMen₁ [] women₁ couples₁ sumPrefLists₁ sumEq₁) p₁ (fst , snd) (fst₁ , snd₁) = {!!}
anyMatchIsBetter m (mkState men freeMen (x ∷ engagedMen) women couples sumPrefLists sumEq) (mkState men₁ freeMen₁ (x₁ ∷ engagedMen₁) women₁ couples₁ sumPrefLists₁ sumEq₁) p₁ (fst , snd) (fst₁ , snd₁) = {!!} --(fst , snd) , (fst₁ , snd₁) , ?
